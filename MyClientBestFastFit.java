...
public class MyClientBestFastFit {
    private Socket socket;
    private DataOutputStream out;
    private BufferedReader in;
    private CharBuffer cb;

    public MyClientBestFastFit() { // construct class fixed properties in Constructors
        try {
    ...
    public static void main(String[] args) {
        ...
        List<ServerNode> serverTypes = client.getServerList(servers);
            ...
            if (jobStr.startsWith("JOBN")) {
                ...
                if (bestNode == null) {
                    for (int i = 0; i < liveList.size(); i++) {
                        ServerNode liveNode = liveList.get(i);
